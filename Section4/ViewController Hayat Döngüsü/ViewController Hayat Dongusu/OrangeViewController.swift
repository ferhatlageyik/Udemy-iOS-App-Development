...
class OrangeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        print("OrangeViewController - View Did Load")
    }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("OrangeViewController - View Will Appear")
    }
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        print("OrangeViewController - View Did Appear")
    }
    ...
    override func viewWillDisappear(_ animated: Bool) {
        ...
        print("OrangeViewController - View Will Disappear")
    }
    ...
    override func viewDidDisappear(_ animated: Bool) {
        ...
        print("OrangeViewController - View Did Disappear")
    }
}
